...
class ElectricFSDataSource:
    ...
    def get_motor_rpm(self):
        # Electric motor: 0-15000 RPM range
...
class FSElectricDashboard(QMainWindow):
    def __init__(self):
        ...
        self.rpm_label.setStyleSheet("color: #00FF41;")  # Bright green
        ...
        main_layout.addWidget(self.rpm_label, 2)  # Stretch factor 2
    ...
    def update_display(self):
        ...
        # Motor RPM with color warning zones
        motor_rpm = self.data_source.get_motor_rpm()
        self.rpm_label.setText(str(motor_rpm))
        
        if motor_rpm > 13000:  # Danger zone
            self.rpm_label.setStyleSheet("color: #FF0000;")  # Red
        elif motor_rpm > 11000:  # Warning zone
            self.rpm_label.setStyleSheet("color: #FFA500;")  # Orange
        else:
            self.rpm_label.setStyleSheet("color: #00FF41;")  # Green
